...
- 双端顶部标题/副标题模板与星期、耗时、截止天数变量
- 双端自动检查 GitHub 最新正式版并提醒下载
...
当前已发布版本为 `v0.1.4`；`main` 正在开发 `v0.1.5`，包含应用内扫码配对、可扩展顶部模板和更新提醒，尚未创建标签或 Release。版本 tag 推送后由 GitHub Actions 自动生成双端安装包；进度见 [执行计划](docs/EXECUTION_PLAN.md)。
