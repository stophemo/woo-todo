...
下载 [Woo-Todo-v0.1.4-android.apk](https://github.com/stophemo/woo-todo/releases/download/v0.1.4/Woo-Todo-v0.1.4-android.apk)，对照 [SHA256SUMS.txt](https://github.com/stophemo/woo-todo/releases/download/v0.1.4/SHA256SUMS.txt) 校验后从三星“我的文件”打开，并允许本次来源安装。连接 ADB 时也可执行：

```bash
adb install -r Woo-Todo-v0.1.4-android.apk
```
